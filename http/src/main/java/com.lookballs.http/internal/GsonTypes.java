...
package com.lookballs.http.internal;
    ...
    private static final class ParameterizedTypeImpl implements ParameterizedType, Serializable {
        ...
        public ParameterizedTypeImpl(Type ownerType, Type rawType, Type... typeArguments) {
            ...
            if (rawType instanceof Class<?>) {
                ...
                GsonPreconditions.checkArgument(ownerType != null || isStaticOrTopLevelClass);
            }
            ...
            for (int t = 0, length = this.typeArguments.length; t < length; t++) {
                GsonPreconditions.checkNotNull(this.typeArguments[t]);
    ...
    private static final class WildcardTypeImpl implements WildcardType, Serializable {
        ...
        public WildcardTypeImpl(Type[] upperBounds, Type[] lowerBounds) {
            ...
            if (lowerBounds.length == 1) {
                GsonPreconditions.checkNotNull(lowerBounds[0]);
                ...
                GsonPreconditions.checkNotNull(upperBounds[0]);
